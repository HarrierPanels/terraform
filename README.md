...
#### Create a private S3 bucket with necessary yaml filesMust be implemented in the form of two modules: one module - everything related to the network; the second is different
